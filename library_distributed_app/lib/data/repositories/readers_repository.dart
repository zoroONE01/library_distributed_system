...
class ReadersRepositoryImpl implements ReadersRepository {
  ...
  @override
  Future<Result<ReaderEntity>> updateReader(String readerId, ReaderEntity reader) async {
    try {
      final model = _mapReaderEntityToModel(reader);
  ...
  @override
  Future<Result<List<ReaderEntity>>> searchReadersSystemWide(String searchTerm) async {
    try {
      ...
      return Failure(Exception('Failed to search readers system-wide: ${response.error}'));
    } catch (e) {
